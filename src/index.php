    ...
    <div class="container">
      <div class="navbar-block">
        ...
        <div class="navbar__info">
          ...
          <button class="button navbar__button" id="button" onclick="ym(62410420, 'reachGoal', 'button'); return true;" value="Заказать">Перезвоните мне</button>
        </div>
      </div>
    </div>
  </nav>
<!-- Первый (главный) блок -->
        ...
        <div class="hero-block">
          ...
          <div class="hero-text">
            ...
            <ul class="hero-list">
              ...
              <li class="hero-list__item wow fadeInLeft" data-wow-delay="0.4s">
                <div class="hero-list__image">
    ...
    <section class="offer section">
      <div class="container">
        <div class="offer-block">
          ...
          <!-- /.section-subtitle -->
            ...
            <!-- /.form offer__form -->
            <button class="up-button button">Наверх</button>
        </div>
      </div>
        <!-- /.container -->
      </section>
      ...
      <section class="section portfolio">
        <div class="container">
          ...
          <div class="slider">
            <div class="slider__item wow fadeIn" data-wow-delay="0.3s"><img class="slider__image" src="img/portfolio/slide-1.jpg" alt=""></div>
            <div class="slider__item wow fadeIn" data-wow-delay="0.4s"><img class="slider__image" src="img/portfolio/slide-2.jpg" alt=""></div>
            <div class="slider__item wow fadeIn" data-wow-delay="0.5s"><img class="slider__image" src="img/portfolio/slide-3.jpg" alt=""></div>
            <div class="slider__item wow fadeIn" data-wow-delay="0.6s"><img class="slider__image" src="img/portfolio/slide-1.jpg" alt=""></div>
            <div class="slider__item wow fadeIn" data-wow-delay="0.7s"><img class="slider__image" src="img/portfolio/slide-2.jpg" alt=""></div>
            <div class="slider__item wow fadeIn" data-wow-delay="0.8s"><img class="slider__image" src="img/portfolio/slide-3.jpg" alt=""></div>
          </div>
          ...
          <div class="arrows portfolio__arrows">
            ...
            <div class="arrows__right">
              <img src="img/portfolio/right-arrow.png" alt="Правая стрелка">
            </div>
          </div>
        ...
        <div class="container">
          ...
          <div class="cards">
            ...
            <div class="card price__card wow fadeInUp" data-wow-delay="0.4s">
              <div class="card__image"><img src="img/price/buidings.png" alt=""></div>
              <!-- /.card__image -->
              <div class="card__text">
            ...
            <div class="card price__card wow fadeInUp" data-wow-delay="0.6s">
              <div class="card__image"><img src="img/price/dinner.png" alt=""></div>
              <!-- /.card__image -->
              <div class="card__text">
        ...
        <div class="container">
          ...
          <div class="brif-block">
            ...
            <div class="form brif__form">
              ...
              <form action="#" id="form" method="get" onsubmit="ym(62410420, 'reachGoal', 'second-form'); return true;">
                <input type="text" name="username" class="input brif__input" placeholder="Ваше имя">
                <input type="tel" id="phone" name="phone" class="input brif__input  phone-number" placeholder="8 (999) 999-99-99">
                <input type="email" name="email"  class="input brif__input" placeholder="Ваш мэйл">
                <button class="button brif__button">Узнать стоимость</button>
                <span class="form-description">Мы перезвоним Вам в течение 60 секунд</span>
              </form>
            </div>
  ...
  <footer class="footer">
    <div class="map" id='map'>
      <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?um=constructor%3Abb27ac7a05578ebd8bf730bdbc3080aab35bc26d2196402b96cd6ce47befae60&amp;width=100%25&amp;height=640&amp;lang=ru_RU&amp;scroll=false"></script>
        ...
        <div class="contacts">
          ...
          <ul class="contacts-list">
            <li class="contacts-list__item">
              ...
              <span class="contacts-list__text">г. Москва <br> ул. Ленинга, д. 10, корпус 2, оф. 308</span>
            </li>
            ...
            <li class="contacts-list__item">
              ...
              <span class="contacts-list__text"> Телефон: <br><a href="tel: +7(495)42-251-31"> + 7 (495) 42-251-31</a></span>
            </li>
          </ul>
        </div>
      </div>
...
/* Валидация первой формы на сайте */
$('#first-form').validate({
      ...
      messages: {
        username: {
          ...
          minlength: jQuery.validator.format("Должно быть не менее {0} букв!"),
          maxlength: jQuery.validator.format("Должно быть не более {0} символов!")
        },  
...
/* Валидация второй формы на сайте */
    $('#form').validate({
